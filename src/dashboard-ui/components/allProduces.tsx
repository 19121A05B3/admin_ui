...
//   //     let category_name: Array<string> = [];
//   //     let crop_name: Array<string> = [];
//   //     let sub_category: Array<string> = [];
//   //     let grade: Array<string> = [];

//   //     sellyes.forEach((item: IItsy) => {
//   //         if (!category_name.includes(item.category_name)) category_name.push(item.category_name);
//   //         if (!crop_name.includes(item.crop_name)) crop_name.push(item.crop_name);
//   //         if (!sub_category.includes(item.sub_category)) sub_category.push(item.sub_category);
//   //         if (!grade.includes(item.grade)) grade.push(item.grade);
//   //     });
